...
// =================================================================================================================================
// CONTROLLER ======================================================================================================================
#define HOST_NAME                "ONSTEPX - ASDEV_V1" // nStep", Hostname for this device up to 16 chars.                                 Adjust

// PINMAP ------------------------------------------------- see https://onstep.groups.io/g/main/wiki/Configuration_Controller#PINMAP
#define PINMAP                        ASDEV_V1 //    OFF, ASDEV_V1 (ESP32-based) pinmap for this build. Other pinmaps are not included. <-Req'd
...
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ 
#define AXIS1_STEPS_PER_DEGREE      3555.555 //  12800, n. Number of steps per degree:                                          <-Req'd
...
// If runtime axis settings are enabled changes in the section below will be ignored (disable in SWS or by wiping NV/EEPROM):
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/
#define AXIS2_STEPS_PER_DEGREE      3555.555 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define MOUNT_TYPE                   ALTAZM_UNL //    GEM, GEM         German Equatorial Mount, etc. that need meridian flips.     <-Req'd
...
#define TIME_LOCATION_SOURCE          OFF //    OFF, DS3231 (I2C,) SD3031 (I2C,) GPS, or NTP source.                           Option
...
#define AXIS3_DRIVER_MODEL            A4988 //    OFF, Enter motor driver model (above) to activate the rotator.                Option
...
#define AXIS3_DRIVER_MICROSTEPS_GOTO  16 //    OFF, n. Microstep mode used during slews. OFF uses _DRIVER_MICROSTEPS.        Option
...
#define AXIS4_DRIVER_MICROSTEPS_GOTO  16 //    OFF, n. Microstep mode used during slews. OFF uses _DRIVER_MICROSTEPS.        Option
...
// FLIP MIRROR ---------------------------------------------------- Custom feature for FlipMirror control
#define FLIP_MIRROR_ENABLE            ON //    OFF, ON enables the FlipMirror servo control feature.                          Option
// Removed: FLIP_MIRROR_SERVO_PIN is provided by the active pinmap (Pins.ASDEV_V1.h)
#define FLIP_MIRROR_CAMERA_DEG        30 //    n. Servo angle for the Camera position.                                         Adjust
#define FLIP_MIRROR_EYEPIECE_DEG     90 //    n. Servo angle for the Eyepiece position.                                      Adjust
