...
class SmallBodyCoordinateProvider : public CoordinateProvider {
public:
    bool supports(const CatalogObject& object) const override {
        ...
        return lower_provider == "smallbody" || lower_provider == "asteroid" || lower_provider == "comet" || lower == "asteroid" || lower == "comet";
    }
